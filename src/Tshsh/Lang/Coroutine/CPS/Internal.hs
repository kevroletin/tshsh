...
-- (isStuckUntillTime == Nothing) and not ready to receive inputs
...
isStuckUntillTime :: Program st i o m r -> Maybe UTCTime
isStuckUntillTime Lift {} = Nothing
isStuckUntillTime GetState {} = Nothing
isStuckUntillTime PutState {} = Nothing
isStuckUntillTime ModifyState {} = Nothing
isStuckUntillTime WaitInput {} = Nothing
isStuckUntillTime (WaitTime (TimeoutAbsolute utc) _) = Just utc
isStuckUntillTime (WaitTime _ _) = Nothing
isStuckUntillTime Output {} = Nothing
isStuckUntillTime Finish {} = Nothing
isStuckUntillTime (Pipe PipeRevNil Nothing (PipeCons p _)) = isStuckUntillTime p
isStuckUntillTime (Pipe _ _ _) = Nothing
isStuckUntillTime (AdapterAll _ _ _ p) = isStuckUntillTime p
isStuckUntillTime (AdapterSt _ p) = isStuckUntillTime p
isStuckUntillTime (Adapter _ _ p) = isStuckUntillTime p
isStuckUntillTime (AndThen p1 _) = isStuckUntillTime p1
isStuckUntillTime (BuffInput (Just _) _) = Nothing
isStuckUntillTime (BuffInput Nothing p) = isStuckUntillTime p
{-# INLINE isStuckUntillTime #-}

isStuckUntillTimeEv :: ProgramEv ev st i o m r -> Maybe UTCTime
isStuckUntillTimeEv (PEv p) = isStuckUntillTime p
{-# INLINE isStuckUntillTimeEv #-}
